...
export const COPY: Record<Locale, Copy> = {
  ...
  hi: {
    ...
    features: [
      ...
      { title: "Chaupal.AI से पूछें", desc: "किसी भी कृषि प्रश्न के लिए AI सहायक। अपनी भाषा में पूछें, तुरंत उत्तर पाएं।" },
    ...
    solutionHeading: "Chaupal.AI समाधान",
    solutions: [
  ...
  mr: {
    ...
    features: [
      ...
      { title: "Chaupal.AI ला विचारा", desc: "कोणत्याही शेती प्रश्नासाठी AI सहाय्यक. तुमच्या भाषेत विचारा, त्वरित उत्तर मिळवा." },
    ...
    solutionHeading: "Chaupal.AI उपाय",
    solutions: [
  ...
  ta: {
    ...
    features: [
      ...
      { title: "Chaupal.AI-ஐக் கேளுங்கள்", desc: "எந்த வேளாண் கேள்விக்கும் AI உதவியாளர். உங்கள் மொழியில் கேளுங்கள், உடனடி பதில் பெறுங்கள்." },
    ...
    solutionHeading: "Chaupal.AI தீர்வு",
    solutions: [
  ...
  te: {
    ...
    features: [
      ...
      { title: "Chaupal.AI ను అడగండి", desc: "ఏ వ్యవసాయ ప్రశ్నకైనా AI సహాయకుడు. మీ భాషలో అడగండి, తక్షణ సమాధానం పొందండి." },
    ...
    solutionHeading: "Chaupal.AI పరిష్కారం",
    solutions: [
